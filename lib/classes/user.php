...
//        $fields['url'] = array('type' => PARAM_URL, 'null' => NULL_NOT_ALLOWED);
        $fields['url'] = array('type' => PARAM_RAW_TRIMMED, 'null' => NULL_NOT_ALLOWED);
        ...
        $fields['cargo'] = array('type' => PARAM_TEXT, 'null' => NULL_NOT_ALLOWED, 'default' => $CFG->defaultcargo);
        $fields['lotacao'] = array('type' => PARAM_TEXT, 'null' => NULL_NOT_ALLOWED);
        $fields['siape'] = array('type' => PARAM_TEXT, 'null' => NULL_NOT_ALLOWED);
        $fields['pemail'] = array('type' => PARAM_EMAIL, 'null' => NULL_NOT_ALLOWED);
        $fields['cpf'] = array('type' => PARAM_TEXT, 'null' => NULL_NOT_ALLOWED);
