...
$string['configtitle'] = 'evagu settings';
...
$string['eva_block_settings'] = '[eva] Advanced block settings';
$string['eva_carousel_settings'] = '[eva] Slider settings';
...
$string['block_styles'] = '[eva] Block styles';
...
$string['eva_copyright'] = 'Copyright notice';
$string['eva_copyright_desc'] = 'The copyright notice for your website.';
$string['social_settings'] = 'Social';
$string['eva_facebook_url'] = 'Facebook URL';
$string['eva_facebook_url_desc'] = 'The link to your company\'s Facebook profile.';
$string['eva_twitter_url'] = 'Twitter URL';
$string['eva_twitter_url_desc'] = 'The link to your company\'s Twitter profile.';
$string['eva_instagram_url'] = 'Instagram URL';
$string['eva_instagram_url_desc'] = 'The link to your company\'s Instagram profile.';
$string['eva_dribbble_url'] = 'Dribbble URL';
$string['eva_dribbble_url_desc'] = 'The link to your company\'s Dribbble profile.';
$string['eva_pinterest_url'] = 'Pinterest URL';
$string['eva_pinterest_url_desc'] = 'The link to your company\'s Pinterest profile.';
$string['eva_google_url'] = 'Google URL';
$string['eva_google_url_desc'] = 'The link to your company\'s Google profile.';
$string['eva_youtube_url'] = 'YouTube URL';
$string['eva_youtube_url_desc'] = 'The link to your company\'s YouTube profile.';
$string['eva_vk_url'] = 'VK URL';
$string['eva_vk_url_desc'] = 'The link to your company\'s VK profile.';
$string['eva_500px_url'] = '500px URL';
$string['eva_500px_url_desc'] = 'The link to your company\'s 500px profile.';
$string['eva_behance_url'] = 'Behance URL';
$string['eva_behance_url_desc'] = 'The link to your company\'s Behance profile.';
$string['eva_digg_url'] = 'Digg URL';
$string['eva_digg_url_desc'] = 'The link to your company\'s Digg profile.';
$string['eva_flickr_url'] = 'Flickr URL';
$string['eva_flickr_url_desc'] = 'The link to your company\'s Flickr profile.';
$string['eva_foursquare_url'] = 'Foursquare URL';
$string['eva_foursquare_url_desc'] = 'The link to your company\'s Foursquare profile.';
$string['eva_linkedin_url'] = 'LinkedIn URL';
$string['eva_linkedin_url_desc'] = 'The link to your company\'s LinkedIn profile.';
$string['eva_medium_url'] = 'Medium URL';
$string['eva_medium_url_desc'] = 'The link to your company\'s Medium profile.';
$string['eva_meetup_url'] = 'Meetup URL';
$string['eva_meetup_url_desc'] = 'The link to your company\'s Meetup profile.';
$string['eva_snapchat_url'] = 'Snapchat URL';
$string['eva_snapchat_url_desc'] = 'The link to your company\'s Snapchat profile.';
$string['eva_tumblr_url'] = 'Tumblr URL';
$string['eva_tumblr_url_desc'] = 'The link to your company\'s Tumblr profile.';
$string['eva_vimeo_url'] = 'Vimeo URL';
$string['eva_vimeo_url_desc'] = 'The link to your company\'s Vimeo profile.';
$string['eva_wechat_url'] = 'WeChat URL';
$string['eva_wechat_url_desc'] = 'The link to your company\'s WeChat profile.';
$string['eva_whatsapp_url'] = 'WhatsApp URL';
$string['eva_whatsapp_url_desc'] = 'The link to your company\'s WhatsApp profile.';
$string['eva_wordpress_url'] = 'WordPress URL';
$string['eva_wordpress_url_desc'] = 'The link to your company\'s WordPress profile.';
$string['eva_weibo_url'] = 'Weibo URL';
$string['eva_weibo_url_desc'] = 'The link to your company\'s Weibo profile.';
$string['eva_telegram_url'] = 'Telegram URL';
$string['eva_telegram_url_desc'] = 'The link to your company\'s Telegram profile.';
$string['eva_moodle_url'] = 'Moodle URL';
$string['eva_moodle_url_desc'] = 'The link to your company\'s Moodle profile.';
$string['eva_amazon_url'] = 'Amazon URL';
$string['eva_amazon_url_desc'] = 'The link to your company\'s Amazon profile.';
$string['eva_slideshare_url'] = 'SlideShare URL';
$string['eva_slideshare_url_desc'] = 'The link to your company\'s SlideShare profile.';
$string['eva_soundcloud_url'] = 'Soundcloud URL';
$string['eva_soundcloud_url_desc'] = 'The link to your company\'s Soundcloud profile.';
$string['eva_leanpub_url'] = 'Leanpub URL';
$string['eva_leanpub_url_desc'] = 'The link to your company\'s Leanpub profile.';
$string['eva_xing_url'] = 'Xing URL';
$string['eva_xing_url_desc'] = 'The link to your company\'s Xing profile.';
$string['eva_bitcoin_url'] = 'Bitcoin URL';
$string['eva_bitcoin_url_desc'] = 'The link to your company\'s Bitcoin profile.';
$string['eva_twitch_url'] = 'Twitch URL';
$string['eva_twitch_url_desc'] = 'The link to your company\'s Twitch profile.';
$string['eva_github_url'] = 'Github URL';
$string['eva_github_url_desc'] = 'The link to your company\'s Github profile.';
$string['eva_gitlab_url'] = 'Gitlab URL';
$string['eva_gitlab_url_desc'] = 'The link to your company\'s Gitlab profile.';
$string['eva_forumbee_url'] = 'Forumbee URL';
$string['eva_forumbee_url_desc'] = 'The link to your company\'s Forumbee profile.';
$string['eva_trello_url'] = 'Trello URL';
$string['eva_trello_url_desc'] = 'The link to your company\'s Trello profile.';
$string['eva_weixin_url'] = 'Weixin URL';
$string['eva_weixin_url_desc'] = 'The link to your company\'s Weixin profile.';
$string['eva_slack_url'] = 'Slack URL';
$string['eva_slack_url_desc'] = 'The link to your company\'s Slack profile.';
...
$string['lazy_loading_desc'] = 'Lazy loading speeds up your website by only loading images once they scroll into view. evagu 2.5 and above introduces experimental lazy loading in some areas of your Moodle website.';
...
$string['blog_post_date_desc'] = 'Show or hide the date on blog posts. This setting controls the blog listing page, individual blog posts, and all [eva] blocks.';
...
$string['icons'] = 'Icons';
$string['icons_desc'] = 'evagu includes 4 iconsets that provide a total of 3000 icons. If you prefer less icons, disable iconsets here. Before disabling iconsets, please make sure that no fields are using icons from the disabled sets.';
$string['iconset_desc'] = 'Load this iconset';
$string['iconset_evagu'] = 'evagu icons';
$string['iconset_eva'] = 'eva icons';
...
$string['for_developers_desc'] = 'Settings provided for developers to aid in further extension of evagu theme.';
$string['dev_expose_blocks'] = 'Expose blocks';
$string['dev_expose_blocks_desc'] = 'Make all custom eva blocks available on all site pages, including the user dashboard and site administration.';
...
$string['inforecuperarsenha'] = 'Para redefinir sua senha, preencha os campos com seu usuário ou e-mail; Sera enviado um e-mail com instruções de como restabelecer seu acesso.';
...
$string['course_error_text'] = 'administrador ainda não configurou o PayPal ou Stripe Enrollment para este curso.';
...
$string['central_agu'] = 'O sistema central da AGU vai confirmar a lotação do usuário';
