...
class block_eva_course_features extends block_base
{
    // Declare first
    public function init()
    {
        $this->title = get_string('eva_course_features', 'block_eva_course_features');
    }
        ...
        <div class="feature_course_widget">
          <ul class="list-group">
            ...
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('lectures', 'theme_evagu').' <span class="float-right">'. format_text($this->content->lectures, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('quizzes', 'theme_evagu').' <span class="float-right">'. format_text($this->content->quizzes, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('duration', 'theme_evagu').' <span class="float-right">'. format_text($this->content->duration, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('skill_level', 'theme_evagu').' <span class="float-right">'. format_text($this->content->skill_level, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('language', 'theme_evagu').' <span class="float-right">'. format_text($this->content->language, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
            <li class="d-flex justify-content-between align-items-center">
                '.get_string('assessments', 'theme_evagu').' <span class="float-right">'. format_text($this->content->assessments, FORMAT_HTML, array('filter' => true)) .'</span>
            </li>
          </ul>
        </div>';
        return $this->content;
