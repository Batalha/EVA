...
class block_eva_globalsearch_n extends block_base {
  ...
  /*    @ccnRef: Block to be discontinued     */
    ...
    public function init() {
        $this->title = get_string('pluginname', 'block_eva_globalsearch_n');
    }
    ...
    public function get_content() {
        ...
        // Input.
        $inputoptions = array('id' => 'searchform_search', 'name' => 'q', 'class' => 'form-control mb-2 mr-sm-2', 'placeholder' => get_string('search_string', 'theme_evagu'), 'type' => 'text', 'size' => '15');
