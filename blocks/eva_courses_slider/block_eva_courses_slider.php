...
class block_eva_courses_slider extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_eva_courses_slider');
    }
    ...
    function specialization() {
        ...
        if (empty($this->config)) {
          ...
          $this->config->button_text = 'Verr todos os Cursos';
