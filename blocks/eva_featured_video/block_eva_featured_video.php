...
class block_eva_featured_video extends block_base
{
    // Declare first
    public function init()
    {
        $this->title = get_string('pluginname', 'block_eva_featured_video');
    }
    ...
    public function get_content(){
        ...
        $fs = get_file_storage();
        $files = $fs->get_area_files($this->context->id, 'block_eva_featured_video', 'content');
                      ...
                      <div class="details">
                        <ul>
                            ...
                            <div
                              ...
                              data-ccn-co="ccnCn"
                              data-ccn-cv="'.$this->content->color_title.'">'.$data->$subtitle.'</div>
                          </li>
          								<li class="list-inline-item">
                            <span
                              data-ccn="'.$subtitle_2.'"
                              ...
                              class="">'.$data->$subtitle_2.'</span></li>
          							</ul>
                        <h5
                          data-ccn="'.$title.'"
                          data-ccn-c="color_subtitle"
                          data-ccn-co="ccnCn"
                          data-ccn-cv="'.$this->content->color_subtitle.'">'.$data->$title.'</h5>
                      </div>
                    </div>
                  </div>';
                }
