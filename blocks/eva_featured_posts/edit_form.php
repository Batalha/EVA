...
class block_eva_featured_posts_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
        ...
        // Title
        $mform->addElement('text', 'config_title', get_string('config_title', 'block_eva_featured_posts'));
        ...
        for($i = 1; $i <= $data->slidesnumber; $i++) {
            ...
            $mform->addElement('text', 'config_slide_title' . $i, get_string('config_slide_title', 'block_eva_featured_posts', $i));
            ...
            $mform->addElement('text', 'config_slide_subtitle' . $i, get_string('config_slide_subtitle', 'block_eva_featured_posts', $i));
            ...
            $f = $mform->addElement('filemanager', 'config_file_slide' . $i, get_string('file_slide', 'block_eva_featured_posts', $i), null, $filemanageroptions);
        }
    ...
    function set_data($defaults) {
        if (!empty($this->block->config) && is_object($this->block->config)) {
            ...
            for($i = 1; $i <= $this->block->config->slidesnumber; $i++) {
                ...
                file_prepare_draft_area($draftitemid, $this->block->context->id, 'block_eva_featured_posts', 'slides', $i, array('subdirs'=>false));
