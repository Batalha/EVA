<?php
$string['pluginname'] = '[eva] Contact Form';
$string['eva_contact_form'] = '[eva] Contact Form';
$string['eva_contact_form:addinstance'] = 'Add a new contact form block';
$string['eva_contact_form:myaddinstance'] = 'Add a new contact form block to the My Moodle page';
