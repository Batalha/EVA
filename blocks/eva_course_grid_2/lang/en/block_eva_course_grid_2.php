...
$string['eva_course_grid_2:addinstance'] = 'Add a [eva] Featured Courses (Large) block';
$string['eva_course_grid_2:myaddinstance'] = 'Add a [eva] Featured Courses (Large) to my moodle';
$string['pluginname'] = '[eva] Featured Courses Large';
...
$string['eva_course_grid_2'] = '[eva] Featured Courses (Large)';
