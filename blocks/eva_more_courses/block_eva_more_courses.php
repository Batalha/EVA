...
class block_eva_more_courses extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_eva_more_courses');
    }
    ...
    function specialization() {
        ...
        $ccnCourses = $ccnCourseHandler->ccnGetExampleCoursesIds(3);
    ...
    public function get_content() {
        ...
        <div class="row">
          <div class="col-lg-12">';
          $this->content->text .='<h3 class="r_course_title" data-ccn="title">'. format_text($this->content->title, FORMAT_HTML, array('filter' => true)) .'</h3>';
          $this->content->text .='
          </div>';
              ...
              $this->content->text .='
                  ...
                  if($ccnBlockShowBottomBar == 1){
                    ...
                    if($ccnBlockShowEnrolBtn){
                      $this->content->text .='<a href="'.$ccnCourse->enrolmentLink.'" data-ccn="enrol_btn_text" class="tc_enrol_btn float-right">'.format_text($this->content->enrol_btn_text, FORMAT_HTML, array('filter' => true)).'</a>';
                    }
