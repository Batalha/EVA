...
$string['eva_my_courses:addinstance'] = 'Add a [eva] My Courses block';
$string['eva_my_courses:myaddinstance'] = 'Add a [eva] My Courses block to my moodle';
$string['pluginname'] = '[eva] My Courses';
$string['eva_my_courses'] = '[eva] My Courses';
