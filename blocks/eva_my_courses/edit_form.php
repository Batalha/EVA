...
class block_eva_my_courses_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        // Title
        $mform->addElement('text', 'config_title', get_string('config_title', 'block_eva_my_courses'));
        ...
        // Hover text
        $mform->addElement('text', 'config_hover_text', get_string('config_hover_text', 'block_eva_featuredcourses'));
        $mform->setDefault('config_hover_text', 'Preview Course');
        $mform->setType('config_hover_text', PARAM_RAW);

        // Hover accent
        $mform->addElement('text', 'config_hover_accent', get_string('config_hover_accent', 'block_eva_featuredcourses'));
        ...
        // $mform->addElement('html', '<a class="btn btn-secondary mt20 mb30 " href="'.$CFG->wwwroot.'/blocks/eva_my_courses/eva_my_courses.php">Select Featured Courses</a>');

        // $mform->addElement('static', 'link',
        //                    get_string('editlink', 'block_eva_my_courses',
        //                               $CFG->wwwroot.'/blocks/eva_my_courses/eva_my_courses.php'));
