...
$string['eva_course_grid_3:addinstance'] = 'Add a [eva] Featured Courses (Large) block';
$string['eva_course_grid_3:myaddinstance'] = 'Add a [eva] Featured Courses (Large) to my moodle';
$string['pluginname'] = '[eva] Featured Courses Masonry 2';
...
$string['eva_course_grid_3'] = '[eva] Featured Courses (Large)';
