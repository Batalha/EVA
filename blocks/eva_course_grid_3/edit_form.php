...
class block_eva_course_grid_3_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        // Hover text
        $mform->addElement('text', 'config_hover_text', get_string('config_hover_text', 'block_eva_course_grid_3'));
        $mform->setDefault('config_hover_text', 'Prévia do Curso');
        $mform->setType('config_hover_text', PARAM_RAW);

        // Hover accent
        $mform->addElement('text', 'config_hover_accent', get_string('config_hover_accent', 'block_eva_course_grid_3'));
        ...
        // $mform->addElement('html', '<a class="btn btn-secondary mt20 mb30 " href="'.$CFG->wwwroot.'/blocks/eva_course_grid_3/eva_course_grid_3.php">Select Featured Courses</a>');
        ...
        $mform->setDefault('config_color_bg', 'rgb(244, 245, 247)');
        ...
        $mform->setDefault('config_color_title', 'rgb(32, 51, 103)');
