...
class block_eva_course_grid_3 extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_eva_course_grid_3');
    }
...
';
    ...
    //               FROM {block_eva_course_grid_3} fc
    //               JOIN {course} c
    //                 ON (c.id = fc.courseid)
    //           ORDER BY sortorder';
    ...
    //     global $DB;
    //     return $DB->delete_records('block_eva_course_grid_3', array('courseid' => $courseid));
    // }
}
