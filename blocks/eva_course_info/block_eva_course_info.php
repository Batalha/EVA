...
class block_eva_course_info extends block_base
{
    // Declare first
    public function init()
    {
        $this->title = get_string('eva_course_info', 'block_eva_course_info');
    }
    ...
    public function get_content()
    {
        ...
        $fs = get_file_storage();
        $files = $fs->get_area_files($this->context->id, 'block_eva_course_info', 'content');
