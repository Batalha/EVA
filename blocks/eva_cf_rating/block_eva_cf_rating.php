...
class block_eva_cf_rating extends block_list {
    function init() {
        $this->title = get_string('pluginname', 'block_eva_cf_rating');
    }
    ...
    function get_content() {
        ...
        $ccnFilter = $ccnCourseHandler->ccnBuildCourseFilterType('filter-rating');
      ...
      <div class="panel">
          <div class="panel-heading">
            <h4 class="panel-title">
              <a href="#panelBodyRating" class="accordion-toggle link fz20 mb15" data-toggle="collapse" data-parent="#accordion">'.$this->content->title.'</a>
            </h4>
          </div>
