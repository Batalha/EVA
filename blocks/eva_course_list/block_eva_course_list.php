...
class block_eva_course_list extends block_list {
    function init() {
        $this->title = get_string('pluginname', 'block_eva_course_list');
    }
              ...
              <div id="panelBodySoftware" class="panel-collapse collapse show">
                <div class="panel-body">
                  <div class="category_sidebar_widget">
                    ...
                    <a class="color-orose" href=" '.$CFG->wwwroot.'/course/index.php"><span class="fa fa-plus pr10"></span> '.get_string('see_more', 'theme_evagu').'</a>
                  </div>
                </div>
              </div>
            </div>
