...
class block_eva_tstmnls_3_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
        ...
        //   '2' => 'Style 3',
        // );
        // $select = $mform->addElement('select', 'config_style', get_string('config_style', 'theme_evagu'), $options);
        ...
        //     'false' => 'False',
        // );
        // $select = $mform->addElement('select', 'config_autoplay', get_string('config_autoplay', 'theme_evagu'), $options);
        ...
        //     '20000' => '20s',
        // );
        // $select = $mform->addElement('select', 'config_speed', get_string('config_speed', 'theme_evagu'), $options);
        ...
        //     'false' => 'False',
        // );
        // $select = $mform->addElement('select', 'config_loop', get_string('config_loop', 'theme_evagu'), $options);
        // $select->setSelected('true');
        ...
        for($i = 1; $i <= $slidesmax; $i++) {
            ...
            $mform->addElement('text', 'config_slide_subtitle' . $i, get_string('config_subtitle', 'theme_evagu', $i));
            $mform->setDefault('config_slide_subtitle' . $i, 'Client');
            $mform->setType('config_slide_subtitle' . $i, PARAM_TEXT);

            $mform->addElement('text', 'config_slide_text' . $i, get_string('config_text', 'theme_evagu', $i));
        ...
        $mform->setDefault('config_color_bg', '#fff8ef');
    ...
    function set_data($defaults) {
        if (!empty($this->block->config) && is_object($this->block->config)) {
            ...
            for($i = 1; $i <= $this->block->config->slidesnumber; $i++) {
                ...
                file_prepare_draft_area($draftitemid, $this->block->context->id, 'block_eva_tstmnls_3', 'slides', $i, array('subdirs'=>false));
