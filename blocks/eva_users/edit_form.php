...
class block_eva_users_edit_form extends block_edit_form {
    ...
    /**
     * Extends the configuration form for block_eva_users.
     */
    protected function specific_definition($mform)
    {
        ...
        $mform->addElement('autocomplete', 'config_users', get_string('eva_users_users', 'block_eva_users'), $usernames, [
        	'multiple' => true,
