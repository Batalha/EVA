...
class block_eva_users extends block_base {
    ...
    public function init() {
        ...
        $this->title = get_string('pluginname', 'block_eva_users');
    }
    ...
    public function get_content() {
        ...
        } else
        {
            ...
            if(empty($users)){
              $this->content->text = get_string('empty', 'block_eva_users');
            } else {
                $list = [];
                ...
                <div class="row">
                  <div class="col-sm-5 col-lg-5 col-xl-6">
                    <div class="instructor_search_result">
								            <p class="mt10 fz15"><span class="color-dark">'. count($list).'</span> '.get_string('instructors', 'theme_evagu').'</p>
                    </div>
                  </div>
                </div>
