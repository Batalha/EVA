<?php
$string['pluginname'] = '[eva] Course Enrolment Custom';
$string['eva_course_enrl_c'] = '[eva] Course Enrolment Custom';
$string['eva_course_enrl_c:addinstance'] = 'Add a new [eva] Course Enrolment Custom block';
$string['eva_course_enrl_c:myaddinstance'] = 'Add a new [eva] Course Enrolment Custom block to the My Moodle page';
