...
class block_eva_featuredcourses extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_eva_featuredcourses');
    }
...
';
    ...
    //               FROM {block_eva_featuredcourses} fc
    //               JOIN {course} c
    //                 ON (c.id = fc.courseid)
    //           ORDER BY sortorder';
    ...
    // public static function delete_eva_featuredcourse($courseid) {
    //     global $DB;
    //     return $DB->delete_records('block_eva_featuredcourses', array('courseid' => $courseid));
    // }
}
