...
class block_eva_blog_recent_list extends block_base {

    function init() {
        $this->title = get_string('pluginname', 'block_eva_blog_recent_list');
    ...
    function get_content() {
       ...
       /* } else {
            $this->content->text .= get_string('norecentblogentries', 'block_eva_blog_recent_list');
        } */
    }
